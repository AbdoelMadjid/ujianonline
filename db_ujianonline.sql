...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 21, 2018 at 11:27 AM
...
(63, 'admin', '21232f297a57a5a743894a0e4a801fc3', '', '', '----Pilih----', '---Pilih---', '---Pilih----', '', '', '', '', '', '', '', 'Y');
...
--
ALTER TABLE `tbl_nilai`
  MODIFY `id_nilai` int(7) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
...
--
ALTER TABLE `tbl_user`
  MODIFY `id_user` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=64;COMMIT;
