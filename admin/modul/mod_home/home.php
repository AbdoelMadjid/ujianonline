...
$sql_nilai_l  = mysqli_query($con,"SELECT count(*) as jum FROM tbl_nilai WHERE keterangan='Lulus'");
$r_nilai_l    = mysqli_fetch_array($sql_nilai_l);
$lulus=$r_nilai_l['jum'];

$sql_nilai_tl  = mysqli_query($con,"SELECT count(*) as jum FROM tbl_nilai WHERE keterangan='Tidak Lulus'");
...
$sql_soal  = mysqli_query($con,"SELECT count(*) as jum FROM tbl_soal WHERE aktif='Y'");
